...
pub(crate) struct ComputationalRuntimeServices {
    ...
    jobs: Arc<crate::merge::computational_job::ComputationalMergeJobRegistry>,
...
impl ComputationalRuntimeServices {
...
mod tests {
    ...
    fn forced_concurrent_supersession_rejects_stale_focus_and_sr_without_cross_family_mutation() {
        let services = Arc::new(ComputationalRuntimeServices::default());
