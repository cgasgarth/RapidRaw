...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            color::calibration::workflow::sample_color_chart,
            color::calibration::workflow::fit_color_chart,
            color::calibration::workflow::cancel_color_chart_calibration,
            color::calibration::workflow::combine_color_chart_calibrations,
