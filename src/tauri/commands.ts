export enum Invokes {
  ...
  CancelDenoising = 'cancel_denoising',
  ...
  CancelFilmProfileThumbnail = 'cancel_film_profile_thumbnail',
  ReleaseFilmProfileThumbnail = 'release_film_profile_thumbnail',
  ...
  EvictAiModelSession = 'evict_ai_model_session',
  ExecuteDenoising = 'execute_denoising',
  ...
  RenderFilmProfileThumbnail = 'render_film_profile_thumbnail',
  HandleFilmThumbnailMemoryPressure = 'handle_film_thumbnail_memory_pressure',
  ...
  ImportCameraProfile = 'import_camera_profile',
  ...
  RemoveCameraProfile = 'remove_camera_profile',
  RevealCameraProfile = 'reveal_camera_profile',
  ...
  AnalyzeToneEqualizerPlacement = 'analyze_tone_equalizer_placement',
