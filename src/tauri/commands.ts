export enum Invokes {
  ...
  CancelColorChartCalibration = 'cancel_color_chart_calibration',
  ...
  CombineColorChartCalibrations = 'combine_color_chart_calibrations',
  ...
  SampleColorChart = 'sample_color_chart',
