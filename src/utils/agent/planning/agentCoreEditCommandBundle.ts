      ...
      [
        {
          ...
          patch: {
            blacks: nextAdjustments.blacks,
            brightness: nextAdjustments.brightness,
            contrast: nextAdjustments.contrast,
            exposure: nextAdjustments.exposure,
            highlights: nextAdjustments.highlights,
            shadows: nextAdjustments.shadows,
            whites: nextAdjustments.whites,
          },
          type: 'patch-edit-document-node',
        },
        {
          nodeType: 'detail_denoise_dehaze',
          patch: { clarity: nextAdjustments.clarity },
          type: 'patch-edit-document-node',
        },
        {
          nodeType: 'color_presence',
          patch: { saturation: nextAdjustments.saturation },
          type: 'patch-edit-document-node',
        },
        {
          nodeType: 'selective_color_mixer',
          patch: { hsl: nextAdjustments.hsl },
          type: 'patch-edit-document-node',
        },
      ],
      `${operationId}_apply`,
