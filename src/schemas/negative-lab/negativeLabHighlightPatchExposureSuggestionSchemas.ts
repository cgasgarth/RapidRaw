...
const negativeLabHighlightPatchExposureStatusSchema = z.enum(['already_safe', 'blocked', 'suggested']);
const negativeLabHighlightPatchExposureRiskSchema = z.enum(['high', 'low', 'medium']);
