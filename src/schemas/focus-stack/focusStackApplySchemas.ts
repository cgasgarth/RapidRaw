...
export const focusStackApplyReceiptSchema = z.object({
  schemaVersion: z.literal(1),
  candidateId: z.string().min(1),
  candidateHash: z.string().min(1),
  acceptedPreviewHash: z.string().min(1),
...
export type FocusStackApplyReceipt = z.infer<typeof focusStackApplyReceiptSchema>;
