export const VISUAL_SMOKE_SCENARIO_IDS = {
  ...
  LightroomHistogramStates: 'lightroom-histogram-states',
...
export const VISUAL_SMOKE_SCENARIOS = [
  ...
  {
    compactOutputFile: 'professional-editor-shell-800x600.png',
    ...
    outputFile: 'professional-editor-shell-1440x900.png',
    reviewOutputFile: 'professional-editor-shell-1968x1280.png',
    reviewViewport: { height: 1280, width: 1968 },
    sectionMinimum: 5,
    viewport: { height: 900, width: 1440 },
  },
  {
    marker: 'Professional editor shell · collapsed',
    mode: VISUAL_SMOKE_SCENARIO_IDS.ProfessionalEditorShellCollapsed,
    outputFile: 'professional-editor-shell-collapsed.png',
    sectionMinimum: 3,
    viewport: { height: 900, width: 1440 },
  },
  {
    marker: 'Professional editor shell · fullscreen',
    mode: VISUAL_SMOKE_SCENARIO_IDS.ProfessionalEditorShellFullscreen,
    outputFile: 'professional-editor-shell-fullscreen.png',
    sectionMinimum: 5,
    viewport: { height: 900, width: 1440 },
  },
  {
