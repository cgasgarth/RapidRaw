...
import { AlertTriangle, Aperture, CheckCircle2, Layers3, ShieldCheck, XCircle } from 'lucide-react';
          ...
          <div className="flex-1 min-w-0 flex flex-col">
            <div className="px-6 py-5 border-b border-surface/70">
              <div className="flex items-start justify-between gap-4">
                ...
                <ComputationalMergeAppServerBadge family="focus_stack" statusLabel={t('editor.ai.connection.ready')} />
              </div>
            </div>
            ...
            <div className="flex-1 min-h-0 overflow-y-auto px-6 py-5 space-y-5">
              ...
              <section>
                <UiText variant={TextVariants.heading} className="mb-3">
                  {t('modals.focusStack.blendLabel')}
                </UiText>
              ...
              <section>
                <UiText variant={TextVariants.heading} className="mb-3">
                  {t('modals.focusStack.retouchLabel')}
                </UiText>
