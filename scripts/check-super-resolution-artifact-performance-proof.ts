...
run(['bun', 'scripts/check-super-resolution-performance-fixtures.ts']);
const started = performance.now();
const runtimeOutput = run(['bun', 'scripts/check-super-resolution-runtime-plan-smoke.ts', '--verbose']);
