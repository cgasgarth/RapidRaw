...
await runRequired('deblur committed proof summary', ['bun', 'run', 'check:deblur-real-raw-private-proof-summary']);
...
if (args.privateRoot === undefined) {
  ...
  console.log('deblur real RAW private proof skipped (RAWENGINE_PRIVATE_RAW_ROOT unset)');
  process.exit(0);
}
...
await runRequired(
  ...
  [
    ...
    'deblur_real_raw_proof::private_runtime_smoke_generates_deblur_real_raw_report_when_enabled',
    '--',
    '--nocapture',
  ],
  {
    ...
    env: {
      ...
      RAWENGINE_RUN_PRIVATE_DEBLUR_REAL_RAW_PROOF: '1',
    },
  },
);
