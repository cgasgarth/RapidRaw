...
for (const command of [
  ['bun', 'scripts/check-raw-open-edit-export-proof.ts'],
  ['bun', 'scripts/check-raw-open-edit-export-command-wrapper.ts'],
  ['bun', 'scripts/check-raw-open-edit-export-run-reports.ts'],
]) {
  run(command);
}
