...
const MANIFEST_PATH = 'docs/api/ui-edit-surface-coverage-2026-06-16.json';
...
if (currentMarkdown !== formattedMarkdown) {
  throw new Error(`${manifest.generatedMarkdownPath} is stale. Run bun scripts/check-ui-api-coverage.mjs --update`);
}
