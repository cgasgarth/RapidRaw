...
const reportSchema = z
  .object({
    ...
    command: z.literal('bun scripts/check-focus-preview-blend-smoke.ts'),
...
run(['bun', 'scripts/check-focus-preview-blend-smoke.ts']);
...
const report = reportSchema.parse({
  ...
  command: 'bun scripts/check-focus-preview-blend-smoke.ts',
  fixtures,
