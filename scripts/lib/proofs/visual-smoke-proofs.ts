...
export const panoramaReviewWorkspaceProofSchema = z.object({
  ...
  planScope: z.literal('tile_runtime_output'),
...
export const panoramaQualityDiagnosticsProofSchema = z.object({
  ...
  exposureAppliedGainCount: z.literal('2'),
  exposureGains: z.literal('1:0.94,3:1.08'),
  exposureMedianLogLuminanceDeltaAfter: z.literal('0.031'),
  exposureMedianLogLuminanceDeltaBefore: z.literal('0.214'),
  inlierEdgeCount: z.literal('4'),
  lowConfidenceSeamCount: z.literal('0'),
  overlapConfidenceLevel: z.literal('medium'),
  overlapConfidencePercent: z.literal('58'),
  overlapMinimumRatio: z.literal('0.24'),
  parallaxRisk: z.literal('medium'),
  seamCount: z.literal('4'),
  seamMaxP95ErrorPx: z.literal('3.1'),
  seamReviewStatus: z.literal('requires_review'),
  seamWarningCodes: z.literal('geometry_estimate_low_confidence'),
  seamWarningState: z.literal('warning'),
  stitchedSourceCount: z.literal('5'),
  warningCodes: z.literal('geometry_estimate_low_confidence'),
});
export const panoramaSavedReviewProofSchema = z.object({
  ...
  projection: z.literal('cylindrical'),
  seamContributionMapArtifactId: z.literal('artifact_visual_panorama_contribution_map'),
  seamCount: z.literal('4'),
  seamMaskArtifactId: z.literal('artifact_visual_panorama_seam_mask'),
  seamMaxP95ErrorPx: z.literal('3.1'),
  seamReviewStatus: z.literal('requires_review'),
...
export const superResolutionReviewWorkspaceProofSchema = z.object({
  ...
  detailReviewHighlightCount: z.literal('3'),
  detailReviewMeanImprovementRatio: z.literal('1.18'),
  detailReviewStatus: z.literal('accepted'),
  estimatedPreviewMegapixels: z.literal('336'),
...
export const layerStackWorkflowProofSchema = z.object({
  ...
  copyMaskApplied: z.literal('true'),
  copyMaskSourceLayer: z.literal('Sky recovery'),
  copyMaskTargetLayer: z.literal('Proof polish'),
...
export const negativeLabPublicExportReviewProofSchema = z.object({
  baseFogSample: z.literal('0,0,0.18000000715255737,1'),
  baseFogStrength: z.literal('1'),
  changedPixelRatio: z.literal('1'),
  densityWeights: z.literal('1,1,1'),
