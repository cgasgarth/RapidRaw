...
const smokeChecks = z.array(SmokeCheckSchema).parse([
  {
    args: ['scripts/checks/ci/check-ci-classify-macos-smoke.ts', '--self-test'],
    budgetMs: 5_000,
    command: 'bun',
  ...
  {
    args: ['tests/integration/checks/film/check-film-look-fixture-outputs.ts'],
    budgetMs: 5_000,
    command: 'bun',
  ...
  {
    args: ['tests/integration/checks/hdr/check-hdr-synthetic-fixtures.ts'],
    budgetMs: 5_000,
    command: 'bun',
    id: 'hdr-fixtures',
  ...
  {
    args: ['packages/rawengine-schema/scripts/check-sample-artifacts.ts'],
    budgetMs: 10_000,
    command: 'bun',
  ...
  {
    args: ['tests/integration/checks/super-resolution/check-super-resolution-performance-fixtures.ts'],
    budgetMs: 5_000,
    command: 'bun',
  ...
  {
    args: ['tests/integration/checks/super-resolution/check-super-resolution-synthetic-smoke.ts'],
    budgetMs: 5_000,
    command: 'bun',
  ...
  {
    args: ['tests/integration/checks/panorama/check-panorama-performance-fixtures.ts'],
    budgetMs: 5_000,
    command: 'bun',
  ...
  {
    args: ['tests/integration/checks/hdr/check-hdr-performance-smoke.ts'],
    budgetMs: 5_000,
    command: 'bun',
  ...
  {
    args: ['tests/integration/checks/focus/check-focus-translation-alignment-smoke.ts'],
    budgetMs: 5_000,
    command: 'bun',
  ...
  {
    args: ['tests/integration/checks/focus/check-focus-sharpness-map-smoke.ts'],
    budgetMs: 5_000,
    command: 'bun',
  ...
  {
    args: ['tests/integration/checks/focus/check-focus-preview-blend-smoke.ts'],
    budgetMs: 5_000,
    command: 'bun',
