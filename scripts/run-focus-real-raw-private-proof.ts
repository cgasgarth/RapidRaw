...
if (args.privateRoot === undefined) {
  ...
  console.log('focus real RAW private proof skipped (RAWENGINE_PRIVATE_RAW_ROOT unset)');
  process.exit(0);
}
...
await runCompact('focus real RAW private root prep', {
  command: [
    'bun',
...
console.log('focus real RAW private proof ok');
