...
if (args.privateRoot === undefined) {
  ...
  console.log('hdr real RAW private proof skipped (RAWENGINE_PRIVATE_RAW_ROOT unset)');
  process.exit(0);
}
...
await runCompact('hdr real RAW Rust proof', {
  command: [
    'cargo',
    'test',
    '--quiet',
...
console.log('hdr real RAW private proof ok');
