...
- `bun run check:selective-color-ranges`
- `bun run check:types`
- `bunx eslint src/utils/selectiveColorRanges.ts src/components/adjustments/Color.tsx scripts/check-selective-color-ranges.mjs --max-warnings 0`
- `bun run check:unsafe-casts`
- `bunx prettier --check src/utils/selectiveColorRanges.ts src/components/adjustments/Color.tsx scripts/check-selective-color-ranges.mjs fixtures/color/selective-color-ranges.json docs/color/selective-color-ranges-2026-06-14.md docs/index.md docs/site-navigation.json RAW_EDITOR_PLAN.md package.json`
