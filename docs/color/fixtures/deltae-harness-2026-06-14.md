...
- `bunx prettier --check tests/integration/checks/check-deltae-fixtures.ts fixtures/color/deltae-reference-fixtures.json docs/color/fixtures/deltae-harness-2026-06-14.md docs/index.md docs/site-navigation.json RAW_EDITOR_PLAN.md package.json`
