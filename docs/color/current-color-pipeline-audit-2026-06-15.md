...
- `bunx prettier --check docs/color/current-color-pipeline-audit-2026-06-15.md scripts/check-color-pipeline-audit.mjs docs/index.md docs/site-navigation.json RAW_EDITOR_PLAN.md package.json scripts/run-compact-checks.mjs`
- `git diff --check`
