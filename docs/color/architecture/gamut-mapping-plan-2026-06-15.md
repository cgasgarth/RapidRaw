...
- `bunx prettier --check docs/color/architecture/gamut-mapping-plan-2026-06-15.md fixtures/color/proofs/gamut-mapping-fixtures.json tests/integration/checks/check-gamut-mapping-fixtures.ts packages/rawengine-schema/src/rawEngineSchemas.ts docs/index.md docs/site-navigation.json RAW_EDITOR_PLAN.md package.json`
