...
- `bunx prettier --check src/utils/skinToneUniformity.ts tests/integration/checks/check-skin-tone-uniformity.ts fixtures/color/skin-tone-uniformity-fixtures.json docs/color/skin-tone-uniformity-2026-06-14.md docs/index.md docs/site-navigation.json RAW_EDITOR_PLAN.md package.json`
