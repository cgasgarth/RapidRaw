...
- `bun run docs:check`
- `bun run format:check -- scripts/check-panorama-fixture-manifest.mjs fixtures/panorama/panorama-fixture-manifest.json docs/validation/panorama-fixture-manifest-2026-06-13.md package.json`
