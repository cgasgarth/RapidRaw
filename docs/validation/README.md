...
- `reports/` contains maintained report templates, not generated local reports.

Private or routine generated artifacts should not be committed. Commit generated
validation output only when it is durable review evidence for a product
behavior, and keep it under the owning proof folder.
