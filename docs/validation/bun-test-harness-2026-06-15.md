...
Keep `scripts/check-*.mjs` for repository policy checks, fixture manifest scans, multi-process validation, external CLIs, generated artifact comparisons, or checks that need custom compact failure output.
