...
- `bun run docs:check`
- `bun run format:check -- tests/integration/checks/check-panorama-fixture-manifest.ts fixtures/panorama/panorama-fixture-manifest.json docs/validation/fixtures/panorama-fixture-manifest-2026-06-13.md package.json`
