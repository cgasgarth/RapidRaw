...
| ------------------------ | --------------- | ------------- |
| Largest JavaScript asset | 2,704,000 bytes | 790,500 bytes |
...
- HDR, panorama, color style, advanced color setup UI, Negative Lab frame queue,
  frame health UI, frame health schema wiring, visible frame warning chips, and
  base sample readouts increased the temporary JavaScript ceiling; future
