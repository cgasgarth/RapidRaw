...
- `masks(ai): research people and parts masks`
  ...
  - Runtime status: people/parts taxonomy, provider tiers, target/artifact schemas, fixture validation, deterministic fake-provider tiny masks, and a validated dry-run picker model are present; React UI wiring and runtime whole-person generation remain future work.
