...
- `masks(ai): research people and parts masks`
  ...
  - Runtime status: people/parts taxonomy, provider tiers, target/artifact schemas, fixture validation, and a validated dry-run picker model are present; React UI, fake provider wiring, and runtime whole-person generation remain future work.
