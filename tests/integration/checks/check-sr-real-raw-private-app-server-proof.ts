...
function sampleRuntimeSample(): RuntimeSample {
  ...
  return runtimeSampleSchema.parse({
    ...
    frames: [
      ...
      shiftY: frame.shiftY,
      sourceIndex: frame.sourceIndex,
      sourcePath: `private-fixtures/super-resolution/subpixel-detail-v1/frame-0${frame.sourceIndex + 1}.nef`,
    })),
    ...
    reports: [
      {
        ...
        screenshotArtifacts: [],
        sourceHashes: [
          source('private-fixtures/super-resolution/subpixel-detail-v1/frame-01.nef'),
          source('private-fixtures/super-resolution/subpixel-detail-v1/frame-02.nef'),
          source('private-fixtures/super-resolution/subpixel-detail-v1/frame-03.nef'),
          source('private-fixtures/super-resolution/subpixel-detail-v1/frame-04.nef'),
        ],
        uiIssue: 1335,
      },
    ],
