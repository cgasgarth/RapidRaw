        ...
        z
          .object({
            ...
            colorManagement: z.object({
              conformance: z.literal('mismatch'),
              observedBitDepth: z.literal(8),
              observedExportColorEncoding: z.literal('current_srgb_pipe_rgba8'),
              observedIccProfileEmbedded: z.literal(false),
              observedOperationDomain: z.literal('linear_srgb_d65_observed'),
              observedOutputProfile: z.literal('untagged_srgb_pipe'),
