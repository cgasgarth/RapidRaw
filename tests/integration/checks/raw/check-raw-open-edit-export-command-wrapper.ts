...
rawOpenEditExportProofReportSchema.parse({
  ...
  finalFile: {
    ...
    cmm: 'lcms2',
    embeddedIccProfileHash: validHash,
    expectedOutputProfileHash: validHash,
    ...
    transformPolicyFingerprint: validHash,
  ...
  renderPaths: {
    ...
    exportAfterWriterId: 'export_processing::save_image_with_metadata',
    previewAfterFormat: 'png',
    previewAfterWriterId: 'image::save',
    previewBeforeWriterId: 'image::save',
    softProofAfterFormat: 'png',
    softProofAfterWriterId: 'image::save',
  },
