...
const workflowStageKeys = [
  ...
  'agentActivity',
  'agentAffectedFrames',
  'agentCommitCommitting',
  'agentCommitNotCommitted',
  'agentCommitReady',
  'agentDryRunAccepted',
  'agentDryRunBlocked',
  'agentDryRunReady',
  ...
  'positiveHandoffReview',
  'positiveHandoffSidecar',
  'previewPending',
  'previewReady',
  'qcApprovedCount',
  'qcDecisionApproved',
...
for (const marker of [
  ...
  'negative-lab-print-curve-v2-controls',
  'negative-lab-print-curve-algorithm',
  'negative-lab-print-curve-algorithm-${algorithm}',
  'negative-lab-print-curve-output-tag',
  'negative-lab-print-curve-output-tag-${outputTag}',
  'negative-lab-print-curve-v2-slider-stack',
  'negative-lab-print-density-targets',
  'negative-lab-v2-qc-runtime-readouts',
  'negative-lab-v2-qc-algorithm',
  'negative-lab-v2-qc-scan-metrics',
  'negative-lab-v2-qc-density-range',
  'negative-lab-v2-qc-clipping-crop',
  'negative-lab-v2-qc-cast-confidence',
  'negative-lab-v2-qc-preview-export-parity',
  'negative-lab-v2-qc-crosstalk',
