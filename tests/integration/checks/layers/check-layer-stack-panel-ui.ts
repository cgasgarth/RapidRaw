...
for (const marker of [
  ...
  'recordLayerMaskPreviewReceipt({ appliedCommandId:',
  ...
  'data-remove-row-status={row.retouchRemoveSource.status ??',
  ...
  'row.retouchCloneSource.scale.toFixed(2)',
  'row.retouchCloneSource.rotationDegrees.toFixed(1)',
  ...
  'revertActiveRemoveLayerToOriginal',
  ...
  'syncRetouchRemoveTargetMask(nextMasks, layerId, retouchRemoveSource, targetCenter)',
