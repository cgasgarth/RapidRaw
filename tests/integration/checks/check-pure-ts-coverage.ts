...
const coverageContracts = [
  {
    ...
    testFiles: ['tests/pure-ts/edit-command-bus.test.ts'],
    minLinePercent: 95,
  ...
  },
  {
    ...
    testFiles: ['tests/pure-ts/levels-runtime.test.ts'],
    minLinePercent: 95,
  ...
  },
  {
    ...
    testFiles: ['tests/pure-ts/library-relink-identity.test.ts'],
    minLinePercent: 95,
    minFunctionPercent: 95,
  },
  {
    ...
    testFiles: ['tests/pure-ts/library-auto-stacks.test.ts'],
    minLinePercent: 90,
  ...
  },
  {
    ...
    testFiles: ['tests/pure-ts/negative-lab-scan-metrics.test.ts'],
    minLinePercent: 90,
  ...
  },
  {
    ...
    testFiles: ['tests/pure-ts/negative-lab-crosstalk-profile.test.ts'],
    minLinePercent: 90,
    minFunctionPercent: 90,
  },
  {
    ...
    testFiles: ['tests/pure-ts/negative-lab-auto-density-suggestions.test.ts'],
    minLinePercent: 85,
    minFunctionPercent: 90,
  },
  {
    ...
    testFiles: ['tests/pure-ts/negative-lab-patch-picker.test.ts'],
    minLinePercent: 95,
    minFunctionPercent: 95,
  },
  {
    ...
    testFiles: ['tests/pure-ts/raw-processing-modes.test.ts'],
    minLinePercent: 95,
    minFunctionPercent: 95,
  },
  {
    ...
    testFiles: [
      'tests/pure-ts/editor-gesture-math.test.ts',
      'tests/pure-ts/editor-preview-dimensions.test.ts',
      'tests/pure-ts/editor-submask-factory.test.ts',
    ],
    minLinePercent: 95,
    minFunctionPercent: 95,
  },
  {
    ...
    testFiles: [
      'tests/pure-ts/folder-tree-utils.test.ts',
      'tests/pure-ts/image-lru-cache.test.ts',
      'tests/pure-ts/virtual-image-path.test.ts',
      'tests/pure-ts/wgpu-transform-payload.test.ts',
    ],
    minLinePercent: 95,
    minFunctionPercent: 90,
  },
  {
    ...
    testFiles: ['tests/pure-ts/export-smart-preview-readiness.test.ts'],
    minLinePercent: 95,
    minFunctionPercent: 95,
  },
  {
    ...
    testFiles: ['tests/pure-ts/xmp-metadata-conflict-schemas.test.ts'],
    minLinePercent: 95,
    minFunctionPercent: 95,
  },
