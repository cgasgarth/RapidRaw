...
for (const marker of [
  ...
  'modals.superResolution.review.artifactComparatorTitle',
  'modals.superResolution.review.artifactComparatorLimitation',
  'modals.superResolution.review.artifactPreviewAlt',
  'modals.superResolution.review.artifactPreviewUnavailable',
  'modals.superResolution.review.artifactStorage',
  'sr-review-artifact-comparator',
