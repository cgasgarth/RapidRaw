...
const requiredLocaleKeys = [
  ...
  'review.cropCoverage',
  'review.cropCoveragePercent',
  'review.exposureDelta',
  'review.exposureDeltaValue',
  'review.exposureGains',
  'review.exposureGainCount',
  'review.inlierEdges',
  'review.inlierEdgesValue',
  'review.maxSeamError',
  'review.maxSeamErrorValue',
