...
describe('EditDocumentV2 camera and detail migrations', () => {
  ...
  test('detail defaults legacy state and rejects malformed render authority', () => {
    const {
      ...
      dustSpotMinRadiusPx: _dustSpotMinRadiusPx,
      dustSpotOverlayEnabled: _dustSpotOverlayEnabled,
      dustSpotSensitivity: _dustSpotSensitivity,
      centré: _centré,
    ...
    expect(defaulted.migration?.defaulted).toEqual(
      expect.arrayContaining([
        ...
        'detail_denoise_dehaze.dustSpotMinRadiusPx',
        'detail_denoise_dehaze.dustSpotOverlayEnabled',
        'detail_denoise_dehaze.dustSpotSensitivity',
    ...
    for (const patch of [
      ...
      { deblurStrength: 32.5 },
      { deblurEnabled: 1 },
      { dustSpotMinRadiusPx: 0 },
      { dustSpotMinRadiusPx: 13 },
      { dustSpotOverlayEnabled: 1 },
      { dustSpotSensitivity: -1 },
      { dustSpotSensitivity: 101 },
      { centré: -101 },
