...
const sampleArtifacts = [
  {
    name: 'query envelope',
    path: 'packages/rawengine-schema/samples/core/query-envelope-v1.json',
    schema: queryEnvelopeV1Schema,
    value: sampleQueryEnvelopeV1,
  },
  {
    name: 'command envelope',
    path: 'packages/rawengine-schema/samples/core/command-envelope-v1.json',
    schema: commandEnvelopeV1Schema,
    value: sampleCommandEnvelopeV1,
  },
  {
    name: 'artifact handle',
    path: 'packages/rawengine-schema/samples/core/artifact-handle-v1.json',
    schema: artifactHandleV1Schema,
    value: sampleArtifactHandleV1,
  },
  {
    name: 'tool registry',
    path: 'packages/rawengine-schema/samples/core/tool-registry-v1.json',
    schema: rawEngineToolRegistryV1Schema,
    value: sampleToolRegistryV1,
  },
  {
    name: 'app-server tool call validation',
    path: 'packages/rawengine-schema/samples/core/app-server-tool-call-validation-v1.json',
  ...
  },
  {
    ...
    path: 'packages/rawengine-schema/samples/agent/agent-replay-fixture-v1.json',
    schema: rawEngineAgentReplayFixtureV1Schema,
    value: sampleRawEngineAgentReplayFixtureV1,
  },
  {
    name: 'basic tone agent replay fixture',
    path: 'packages/rawengine-schema/samples/agent/basic-tone-agent-replay-fixture-v1.json',
    schema: rawEngineAgentReplayFixtureV1Schema,
    value: sampleBasicToneAgentReplayFixtureV1,
  },
  {
    name: 'AI tool command envelope',
    path: 'packages/rawengine-schema/samples/ai/tools/ai-tool-command-envelope-v1.json',
    schema: aiToolCommandEnvelopeV1Schema,
    value: sampleAiToolCommandEnvelopeV1,
  },
  {
    name: 'AI tool apply command envelope',
    path: 'packages/rawengine-schema/samples/ai/tools/ai-tool-apply-command-envelope-v1.json',
    schema: aiToolCommandEnvelopeV1Schema,
    value: sampleAiToolApplyCommandEnvelopeV1,
  },
  {
    name: 'AI tool dry-run result',
    path: 'packages/rawengine-schema/samples/ai/tools/ai-tool-dry-run-result-v1.json',
    schema: aiToolDryRunResultV1Schema,
    value: sampleAiToolDryRunResultV1,
  },
  {
    name: 'AI tool apply result',
    path: 'packages/rawengine-schema/samples/ai/tools/ai-tool-apply-result-v1.json',
    schema: aiToolApplyResultV1Schema,
    value: sampleAiToolApplyResultV1,
  },
  {
    name: 'AI tool agent replay fixture',
    path: 'packages/rawengine-schema/samples/agent/ai-tool-agent-replay-fixture-v1.json',
    schema: rawEngineAgentReplayFixtureV1Schema,
    value: sampleAiToolAgentReplayFixtureV1,
  },
  {
    name: 'AI app-server tool manifest',
    path: 'packages/rawengine-schema/samples/ai/tools/ai-app-server-tool-manifest-v1.json',
    schema: aiAppServerToolManifestV1Schema,
    value: sampleAiAppServerToolManifestV1,
  },
  {
    name: 'AI enhancement command envelope',
    path: 'packages/rawengine-schema/samples/ai/enhancement/ai-enhancement-command-envelope-v1.json',
  ...
  },
  {
    ...
    path: 'packages/rawengine-schema/samples/hdr/computational-merge-hdr-command-envelope-v1.json',
    schema: computationalMergeCommandEnvelopeV1Schema,
    value: sampleComputationalMergeHdrCommandEnvelopeV1,
  },
  {
    name: 'computational merge focus stack command envelope',
    path: 'packages/rawengine-schema/samples/focus-stack/computational-merge-focus-stack-command-envelope-v1.json',
    schema: computationalMergeCommandEnvelopeV1Schema,
    value: sampleComputationalMergeFocusStackCommandEnvelopeV1,
  },
  {
    name: 'focus stack artifact',
    path: 'packages/rawengine-schema/samples/focus-stack/focus-stack-artifact-v1.json',
    schema: focusStackArtifactV1Schema,
    value: sampleFocusStackArtifactV1,
  },
  {
    name: 'HDR merge artifact',
    path: 'packages/rawengine-schema/samples/hdr/hdr-merge-artifact-v1.json',
    schema: hdrMergeArtifactV1Schema,
    value: sampleHdrMergeArtifactV1,
  },
  {
    name: 'computational merge focus stack apply command envelope',
    path: 'packages/rawengine-schema/samples/focus-stack/computational-merge-focus-stack-apply-command-envelope-v1.json',
    schema: computationalMergeCommandEnvelopeV1Schema,
    value: sampleComputationalMergeFocusStackApplyCommandEnvelopeV1,
  },
  {
    name: 'computational merge super-resolution command envelope',
    path: 'packages/rawengine-schema/samples/super-resolution/computational-merge-super-resolution-command-envelope-v1.json',
    schema: computationalMergeCommandEnvelopeV1Schema,
  ...
  },
  {
    ...
    path: 'packages/rawengine-schema/samples/super-resolution/computational-merge-single-image-super-resolution-command-envelope-v1.json',
    schema: computationalMergeCommandEnvelopeV1Schema,
    value: sampleComputationalMergeSingleImageSuperResolutionCommandEnvelopeV1,
  },
  {
    name: 'computational merge dry-run result',
    path: 'packages/rawengine-schema/samples/computational-merge/computational-merge-dry-run-result-v1.json',
  ...
  },
  {
    ...
    path: 'packages/rawengine-schema/samples/computational-merge/computational-merge-mutation-result-v1.json',
  ...
  },
  {
    ...
    path: 'packages/rawengine-schema/samples/computational-merge/computational-merge-app-server-tool-manifest-v1.json',
  ...
  },
  {
    ...
    path: 'packages/rawengine-schema/samples/panorama/computational-merge-panorama-dry-run-app-server-tool-call-validation-v1.json',
    schema: rawEngineAppServerToolCallValidationV1Schema,
  ...
  },
  {
    ...
    path: 'packages/rawengine-schema/samples/panorama/computational-merge-panorama-apply-app-server-tool-call-validation-v1.json',
    schema: rawEngineAppServerToolCallValidationV1Schema,
  ...
  },
  {
    ...
    path: 'packages/rawengine-schema/samples/focus-stack/computational-merge-focus-stack-dry-run-app-server-tool-call-validation-v1.json',
    schema: rawEngineAppServerToolCallValidationV1Schema,
  ...
  },
  {
    ...
    path: 'packages/rawengine-schema/samples/focus-stack/computational-merge-focus-stack-apply-app-server-tool-call-validation-v1.json',
    schema: rawEngineAppServerToolCallValidationV1Schema,
  ...
  },
  {
    ...
    path: 'packages/rawengine-schema/samples/super-resolution/computational-merge-super-resolution-dry-run-app-server-tool-call-validation-v1.json',
    schema: rawEngineAppServerToolCallValidationV1Schema,
  ...
  },
  {
    ...
    path: 'packages/rawengine-schema/samples/super-resolution/computational-merge-super-resolution-apply-app-server-tool-call-validation-v1.json',
    schema: rawEngineAppServerToolCallValidationV1Schema,
    value: sampleComputationalMergeSuperResolutionApplyAppServerToolCallValidationV1,
  },
  {
    name: 'super-resolution dry-run summary',
    path: 'packages/rawengine-schema/samples/super-resolution/super-resolution-dry-run-summary-v1.json',
    schema: superResolutionDryRunSummaryV1Schema,
    value: sampleSuperResolutionDryRunSummaryV1,
  },
  {
    name: 'super-resolution artifact',
    path: 'packages/rawengine-schema/samples/super-resolution/super-resolution-artifact-v1.json',
    schema: superResolutionArtifactV1Schema,
    value: sampleSuperResolutionArtifactV1,
  },
  {
    name: 'preview scope query',
    path: 'packages/rawengine-schema/samples/preview/preview-scope-query-v1.json',
    schema: previewScopeQueryV1Schema,
    value: samplePreviewScopeQueryV1,
  },
  {
    name: 'preview scope result',
    path: 'packages/rawengine-schema/samples/preview/preview-scope-result-v1.json',
    schema: previewScopeResultV1Schema,
    value: samplePreviewScopeResultV1,
  },
  {
    name: 'project library snapshot query',
    path: 'packages/rawengine-schema/samples/project-library/project-library-snapshot-query-v1.json',
    schema: projectLibrarySnapshotQueryV1Schema,
    value: sampleProjectLibrarySnapshotQueryV1,
  },
  {
    name: 'project library snapshot',
    path: 'packages/rawengine-schema/samples/project-library/project-library-snapshot-v1.json',
    schema: projectLibrarySnapshotV1Schema,
    value: sampleProjectLibrarySnapshotV1,
  },
  {
    name: 'project library command envelope',
    path: 'packages/rawengine-schema/samples/project-library/project-library-command-envelope-v1.json',
  ...
  },
  {
    ...
    path: 'packages/rawengine-schema/samples/negative-lab/calibration/negative-lab-density-normalization-profile-v1.json',
  ...
  },
  {
    ...
    path: 'packages/rawengine-schema/samples/negative-lab/workflows/negative-lab-frame-detection-result-v1.json',
  ...
  },
  {
    ...
    path: 'packages/rawengine-schema/samples/negative-lab/calibration/negative-lab-base-sample-record-v1.json',
    schema: negativeLabBaseSampleRecordV1Schema,
    value: sampleNegativeLabBaseSampleRecordV1,
  },
  {
    name: 'negative lab base fog estimate',
    path: 'packages/rawengine-schema/samples/negative-lab/calibration/negative-lab-base-fog-estimate-v1.json',
    schema: negativeLabBaseFogEstimateV1Schema,
    value: sampleNegativeLabBaseFogEstimateV1,
  },
  {
    name: 'negative lab process profile',
    path: 'packages/rawengine-schema/samples/negative-lab/calibration/negative-lab-process-profile-v1.json',
  ...
  },
  {
    ...
    path: 'packages/rawengine-schema/samples/negative-lab/calibration/negative-lab-per-channel-inversion-curve-set-v1.json',
  ...
  },
  {
    ...
    path: 'packages/rawengine-schema/samples/negative-lab/fixtures/negative-lab-qc-proof-artifact-v1.json',
    schema: negativeLabQcProofArtifactV1Schema,
    value: sampleNegativeLabQcProofArtifactV1,
  },
  {
    name: 'negative lab roll batch workflow',
    path: 'packages/rawengine-schema/samples/negative-lab/workflows/negative-lab-roll-batch-workflow-v1.json',
    schema: negativeLabRollBatchWorkflowV1Schema,
    value: sampleNegativeLabRollBatchWorkflowV1,
  },
  {
    name: 'negative lab dry-run result',
    path: 'packages/rawengine-schema/samples/negative-lab/workflows/negative-lab-dry-run-result-v1.json',
    schema: negativeLabDryRunResultV1Schema,
    value: sampleNegativeLabDryRunResultV1,
  },
  {
    name: 'negative lab apply plan request',
    path: 'packages/rawengine-schema/samples/negative-lab/workflows/negative-lab-apply-plan-request-v1.json',
    schema: negativeLabApplyPlanRequestV1Schema,
    value: sampleNegativeLabApplyPlanRequestV1,
  },
  {
    name: 'negative lab apply result',
    path: 'packages/rawengine-schema/samples/negative-lab/workflows/negative-lab-apply-result-v1.json',
    schema: negativeLabApplyResultV1Schema,
    value: sampleNegativeLabApplyResultV1,
  },
  {
    name: 'negative lab conversion operation',
    path: 'packages/rawengine-schema/samples/negative-lab/workflows/negative-lab-conversion-operation-v1.json',
  ...
  },
  {
    ...
    path: 'packages/rawengine-schema/samples/negative-lab/workflows/negative-lab-app-server-tool-manifest-v1.json',
  ...
  },
  {
    ...
    path: 'packages/rawengine-schema/samples/negative-lab/fixtures/negative-lab-positive-variant-provenance-v1.json',
  ...
  },
  {
    ...
    path: 'packages/rawengine-schema/samples/negative-lab/presets/negative-lab-preset-metadata-policy-catalog-v1.json',
  ...
  },
  {
    ...
    path: 'packages/rawengine-schema/samples/negative-lab/fixtures/negative-lab-fixture-manifest-v1.json',
    schema: negativeLabFixtureManifestV1Schema,
    value: sampleNegativeLabFixtureManifestV1,
  },
  {
    name: 'negative lab input profile catalog',
    path: 'packages/rawengine-schema/samples/negative-lab/presets/negative-lab-input-profile-catalog-v1.json',
