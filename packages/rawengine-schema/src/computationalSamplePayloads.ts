...
export const sampleFocusStackArtifactV1: FocusStackArtifactV1 = focusStackArtifactV1Schema.parse({
  ...
  haloMapArtifact: {
    artifactId: 'artifact_focus_stack_macro_0001_halo_map',
    contentHash: 'sha256:sample-focus-halo-map',
    dimensions: {
      height: 1200,
      width: 1800,
    },
  ...
  haloReview: {
    artifactHash: 'sha256:sample-focus-halo-map',
    artifactId: 'artifact_focus_stack_macro_0001_halo_map',
    editableHandoffStatus: 'review_required',
    haloRiskCellRatio: 0.12,
    lowConfidenceCellRatio: 0.04,
    reviewStatus: 'review_required',
    transitionRiskRegions: [
      {
        cellCount: 1,
        regionId: 'focus-cell-1',
        risk: 'stable',
        sourceIndex: 0,
      },
      {
        cellCount: 1,
        regionId: 'focus-cell-2',
        risk: 'halo_risk',
        sourceIndex: 1,
      },
      {
        cellCount: 1,
        regionId: 'focus-cell-3',
        risk: 'retouch_recommended',
        sourceIndex: 2,
      },
    ],
  },
...
export const sampleSuperResolutionArtifactV1: SuperResolutionArtifactV1 = superResolutionArtifactV1Schema.parse({
  ...
  measuredReview: {
    detailGainRatio: 1.72,
    detailReviewRegions: [
      {
        baselineSharpnessScore: 0.54,
        improvementRatio: 1.18,
        label: 'center microcontrast',
        reconstructedSharpnessScore: 0.6372,
      ...
      },
      {
        ...
        reconstructedSharpnessScore: 0.5472,
        regionId: 'fine-edge-texture',
        reviewStatus: 'accepted',
      },
      {
        baselineSharpnessScore: 0.42,
        improvementRatio: 1.09,
        label: 'low-contrast detail',
        reconstructedSharpnessScore: 0.4578,
        regionId: 'low-contrast-detail',
        reviewStatus: 'accepted',
      },
    ],
    downscaleReconstructionError: 0.011,
    falseDetailRisk: 'low',
    falseDetailRiskScore: 0.12,
  },
  qualityPreference: sampleSuperResolutionQualityPreference,
  requestedAlignmentMode: sampleSuperResolutionAlignmentMode,
